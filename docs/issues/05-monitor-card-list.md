...
- Action buttons:
  ...
  - (Abort button is wired here, actual abort logic from Issue 07)
...
- Issue 04: Command queue + REST (`docs/issues/04-command-queue-submit-approve-deny.md`) — provides REST endpoints and WS card push
